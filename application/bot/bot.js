...
import getAllLectures from './lecture/telegram/get-lecture.js';
import startLecture from './lecture/telegram/start-lecture.js';
...
export const initBot = async (botConfig, services) => {
  ...
  await bot.api.setMyCommands([
    ...
    { command: 'get_all_lectures', description: 'Get lectures' },
    {
  ...
  bot.use(getAllLectures(services.lectureService));
  bot.use(startLecture(services.lectureService));
